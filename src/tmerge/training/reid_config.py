"""TorchReID configuration helpers for the modern training path."""
...
def imagedata_kwargs(cfg: CN) -> dict[str, object]:
    return {
        "root": cfg.data.root,
...
def videodata_kwargs(cfg: CN) -> dict[str, object]:
    return {
        "root": cfg.data.root,
        "sources": cfg.data.sources,
        "targets": cfg.data.targets,
...
def optimizer_kwargs(cfg: CN) -> dict[str, object]:
    return {
...
def lr_scheduler_kwargs(cfg: CN) -> dict[str, object]:
    return {
...
def engine_run_kwargs(cfg: CN) -> dict[str, object]:
    return {
